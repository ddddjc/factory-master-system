 ...
 */
@RestController
@RequestMapping("accessoriesProcurement")
public class AccessoriesProcurementController<E> {
     ...
     */
    @GetMapping
    public JsonResult<Page<AccessoriesProcurement>> queryByPage(AccessoriesProcurement accessoriesProcurement, PageRequest pageRequest) {
        return new JsonResult<>(200, "查询成功", this.accessoriesProcurementService.queryByPage(accessoriesProcurement, pageRequest));
    }
     ...
     */
    @GetMapping("{id}")
    public JsonResult<AccessoriesProcurement> queryById(@PathVariable("id") Integer id) {
        return new JsonResult<>(200, "查询成功", this.accessoriesProcurementService.queryById(id));
    }
